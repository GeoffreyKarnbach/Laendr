...
INSERT INTO review_renter(id, rating, comment, created_at, updated_at, reputation_id, reviewer_id, reviewee_karma, reviewer_karma)
VALUES (-1, 2, 'comment', current_timestamp, current_timestamp, -3, -1, 1, 1);

INSERT INTO transaction(id, initial_message, created_at, updated_at, completed_at, timeslot_id, renter_id, review_location_id, review_renter_id)
VALUES (-1, 'message', current_timestamp, current_timestamp, current_timestamp, -1, -3, -1, -1);